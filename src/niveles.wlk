...
object nivel1 inherits Niveles {
	...
	method iniciar() {
		...
		const alcantarilla1 = new Alcantarilla(position = game.at(2, 2), grafico = 'tuerca.png', salida = [6, 6])
		const alcantarilla2 = new Alcantarilla(position = game.at(6, 6), grafico = 'tuerca.png', salida = [2, 2])
