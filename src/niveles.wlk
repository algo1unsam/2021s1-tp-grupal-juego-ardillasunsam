...
object nivel2 inherits Nivel {
	...
	override method instanciarObjetos() {
		...
		sobrevivientes.add(new Jugador(position = game.at(-55, 0), grafico = "george", vidas = 1))
		sobrevivientes.add(new Jugador(position = game.at(-30, 0), grafico = "george", vidas = 1))
		sobrevivientes.add(new Jugador(position = game.at(-40, 0), grafico = "george", vidas = 1))
